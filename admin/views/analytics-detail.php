                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($item->country_code)) : ?>
                                    <img src="<?php echo esc_url(SHORT_URL_PLUGIN_URL . 'admin/flags/' . Short_URL_Utils::get_flag_country_code($item->country_code) . '.svg'); ?>" 
...
<script>
    jQuery(document).ready(function($) {
        ...
        $('.country-flag-placeholder').each(function() {
            ...
            if (countryCode) {
                // Convert country codes using our PHP mapping
                var countryCodeMap = <?php echo json_encode(array(
                ...
                var threeLetterCode = countryCodeMap[countryCode] || countryCode;
                var flagUrl = '<?php echo esc_url(SHORT_URL_PLUGIN_URL . 'admin/flags/'); ?>' + threeLetterCode + '.svg';
